...
WSRESTFUL zWSPedidos DESCRIPTION 'WebService Peddidos'
    ...
    WSMETHOD GET ALLPO DESCRIPTION 'Todos os Pedido do Dia' WSSYNTAX '/zWSPO/get_all_po?{data1, data2}' PATH 'get_all_po' PRODUCES APPLICATION_JSON
    WSMETHOD GET FORNECEDOR DESCRIPTION 'Fornecedor por Codigo' WSSYNTAX '/zWSPO/get_fornecedor_details?{codigo}' PATH 'get_fornecedor_details' PRODUCES APPLICATION_JSON
